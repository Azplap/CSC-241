...
def problem4():
	...
	sigmas = [1,5,10]
	spike_counter, spike_times, ISI = [],[],[]

	#runs the formula 3 times for 3 diff sigmas
	for sig in sigmas:
	...
	for times in spike_times:
		temp=[]
		#adds three arrays of diff for three sigmas
		ISI.append(temp)
	...
	n = len(ISI[2]) 
	print(round(coefficientOfVariation(ISI[2], n), 5)) 
